## Перечень задач в виде плана. :point_down:
   ...
   - [x] 15. Ознакомиться с документацией по **axios**: **https://github.com/axios/axios**

        - [x] 15. 1. Разобраться с параметрами к get-запросу;

        - [x] 15. 2. Разобраться с необходимыми заголовками для выполнения кросс-доменных запрсов;

        - [x] 15. 3. Составить тестовый get-запрос через **axios** на получение 10 юзеров, запросить фото, имя и фамилию на VK API.
