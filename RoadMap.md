## Перечень задач в виде плана. :point_down:
   ...
   - [ ] 15. Реализовать запрос на VK API:

        - [ ] 15. 1. Разобраться с параметрами метода **users.search**: **https://vk.com/dev/users.search**

        - [ ] 15. 2. Разобраться с форматом url'а для релизации авторизации на: **OAth** и получением тоукена для работы с методом **users.search**. Составленный URL:
        ...
        - [ ] 15. 3. С полученным тоукеном реализовать необходимый тестовый запрос:
