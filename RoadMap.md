## Перечень задач в виде плана. :point_down:
   ...
   - [ ] 20. Реализовать в проекте бесконечную прокрутку на главной странице:
        ...
        - [x] 20. 3. При скролле страницы вниз реализовать автоподгрузку контента:
            ...
            - [x] 20. 3. 1. Ознакомиться с работой по работе с размером и прокруткой страницы: *document.body.scrollHeight* (высота страницы с учётом прокрутки),

            *window.innerHeight* (текущий размер окна браузера), *document.scrollingElement.scrollTop* (текущая прокрутка в документе).
